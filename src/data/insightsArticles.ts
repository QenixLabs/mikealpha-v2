...
const rewriteAnswer = (html: string): string => {
  ...
  return html
    .replace(
      /href="https?:\/\/[^"]*Mike Alpha-group\.com(\/[^"]*)"/g,
...
export const insightsArticles: InsightsArticle[] = [
  {
    ...
    cards: [
      {
        title: 'Mike Alpha Insights: Bridging Continents - A Conversation on Leadership and Agribusiness',
        image:
          'https://www.mike-alpha-group.com/sites/default/files/styles/max_1024/public/2026-02/ywtywb_bnr.jpg?itok=uo5w3-Ki',
        link: 'https://www.mike-alpha-group.com/podcast/mike-alpha-insights-bridging-continents-conversation-leadership-and-agribusiness',
      },
      {
        title: 'Mike AlphaStream: 2 tanks fertilizer stock solution - the nutritional base for your crop - Episode 2',
        image: 'https://www.mike-alpha-group.com/themes/mike-alpha/images/mike-alpha-main-logo.png',
        link: 'https://www.mike-alpha-group.com/podcast/mike-alphatream-2-tanks-fertilizer-stock-solution-nutritional-base-your-crop-episode-2',
      },
      {
        title: 'Mike AlphaStream: Shifting to water recirculated irrigation systems carries potential benefits - what are the risks and necessities to make the change.',
        image: 'https://www.mike-alpha-group.com/themes/mike-alpha/images/mike-alpha-main-logo.png',
        link: 'https://www.mike-alpha-group.com/podcast/mike-alphatream-shifting-water-recirculated-irrigation-systems-carries-potential-benefits-what',
      },
      {
        title: 'Mike AlphaStream: Lab analysis is often recognized as unnecessary expanse - is it really needed?',
        image: 'https://www.mike-alpha-group.com/themes/mike-alpha/images/mike-alpha-main-logo.png',
        link: 'https://www.mike-alpha-group.com/podcast/httpsomnyfmshowsmike-alphatream-greenhouse-plant-nutrition-mike-alpha-grmike-alpha-stream-lab-analysis',
      },
      {
        title: 'Mike AlphaStream: Grafted vines in greenhouses – a growing trend',
        image: 'https://www.mike-alpha-group.com/themes/mike-alpha/images/mike-alpha-main-logo.png',
        link: 'https://www.mike-alpha-group.com/podcast/mike-alphatream-grafted-vines-greenhouses-growing-trend',
      },
      {
        title: 'Mike AlphaStream: Ions Antagonism and Synergism – because shortages do not necessarily mean being short',
        image: 'https://www.mike-alpha-group.com/themes/mike-alpha/images/mike-alpha-main-logo.png',
        link: 'https://www.mike-alpha-group.com/podcast/mike-alphatream-ions-antagonism-and-synergism-because-shortages-do-not-necessarily-mean-being',
      },
      {
        title: 'Mike AlphaStream: Managing Water Contents in your Substrate – How and Why',
        image: 'https://www.mike-alpha-group.com/themes/mike-alpha/images/mike-alpha-main-logo.png',
        link: 'https://www.mike-alpha-group.com/podcast/mike-alphatream-managing-water-contents-your-substrate-how-and-why-mike-alphatream-greenhouse-plant',
      },
      {
        title: 'Mike AlphaStream: pH Control in soilless cultivation – a crucial factor for nutritional efficiency. Manage it the right way!',
        image: 'https://www.mike-alpha-group.com/themes/mike-alpha/images/mike-alpha-main-logo.png',
        link: 'https://www.mike-alpha-group.com/podcast/mike-alphatream-ph-control-soilless-cultivation-crucial-factor-nutritional-efficiency-manage-it',
      },
      {
        title: 'Mike AlphaStream: Clogged drippers - more common than you think. Yes, there is an easy solution',
        image: 'https://www.mike-alpha-group.com/themes/mike-alpha/images/mike-alpha-main-logo.png',
        link: 'https://www.mike-alpha-group.com/podcast/mike-alphatream-clogged-drippers-more-common-you-think-yes-theres-easy-solution',
      },
      {
        title: 'Mike AlphaStream: When roots uptake is not enough - Foliar application',
        image: 'https://www.mike-alpha-group.com/themes/mike-alpha/images/mike-alpha-main-logo.png',
        link: 'https://www.mike-alpha-group.com/podcast/mike-alphatream-when-roots-uptake-not-enough-foliar-application',
      },
      {
        title: 'Mike AlphaStream: Calcium nutrition - How small actions can lead to great differences',
        image: 'https://www.mike-alpha-group.com/themes/mike-alpha/images/mike-alpha-main-logo.png',
        link: 'https://www.mike-alpha-group.com/podcast/mike-alphatream-calcium-nutrition-how-small-actions-can-lead-great-differences',
      },
      {
        title: 'Mike AlphaStream: Not just availability - Nutrient ratios and EC are critical for your crop success',
        image: 'https://www.mike-alpha-group.com/themes/mike-alpha/images/mike-alpha-main-logo.png',
        link: 'https://www.mike-alpha-group.com/podcast/mike-alphatream-not-just-availability-nutrient-ratios-and-ec-are-critical-your-crops-success',
      },
      {
        title: 'Mike AlphaStream: Water is the key to life and plant nutrition - What should you consider regarding your water source?',
        image: 'https://www.mike-alpha-group.com/themes/mike-alpha/images/mike-alpha-main-logo.png',
        link: 'https://www.mike-alpha-group.com/podcast/mike-alphatream-water-key-life-and-plant-nutrition-what-should-you-consider-regarding-your-water',
      },
      {
        title: 'Mike AlphaStream: Stock solution - the nutritional base for your crop. Simple tips & tricks',
        image: 'https://www.mike-alpha-group.com/themes/mike-alpha/images/mike-alpha-main-logo.png',
        link: 'https://www.mike-alpha-group.com/podcast/mike-alphatream-stock-solution-nutritional-base-your-crop-simple-tips-tricks',
      },
    ],
  },
  {
    ...
    cards: [
      {
        ...
        image:
          'https://www.mike-alpha-group.com/sites/default/files/styles/branch/public/2026-06/thumbnail_4.jpg?itok=5ZhC447s',
        link: 'https://www.mike-alpha-group.com/success-stories/avocado-mike-alphatim-vital-chile',
      },
      {
        title: 'Multicote™ Agri in Potato: More Yield, Better ROI',
        image:
          'https://www.mike-alpha-group.com/sites/default/files/styles/branch/public/2026-06/thumbnail_2.jpg?itok=4ZG8NlIE',
        link: 'https://www.mike-alpha-group.com/success-stories/multicote-agri-potato-colombia-roi',
      },
      {
        title: 'Optimizing Kiwi Cultivation with Mike Alpha 360 Strategy',
        image:
          'https://www.mike-alpha-group.com/sites/default/files/styles/branch/public/2026-05/thumbnail_3.jpg?itok=XdtPO7lW',
        link: 'https://www.mike-alpha-group.com/success-stories/mike-alpha-360-kiwi-italy',
      },
      {
        title: 'Growing Stronger Cucumbers Under Stress',
        image:
          'https://www.mike-alpha-group.com/sites/default/files/styles/branch/public/2026-05/thumbnail.jpg?itok=DXR_vuYE',
        link: 'https://www.mike-alpha-group.com/success-stories/wall-up-cucumber-mexico',
      },
      {
        title: 'Mike AlphaStim™ Powers Banana Performance from the Ground Up',
        image:
          'https://www.mike-alpha-group.com/sites/default/files/styles/branch/public/2026-04/thumbnail_2.jpg?itok=RhCrUg71',
        link: 'https://www.mike-alpha-group.com/success-stories/mike-alphatim-banana-mexico',
      },
      {
        title: 'Taking Citrus Nutrition to the Next Level: Proven Results from South Africa',
        image:
          'https://www.mike-alpha-group.com/sites/default/files/styles/branch/public/2026-03/thumbnail_1.jpg?itok=TkoZRGrH',
        link: 'https://www.mike-alpha-group.com/success-stories/mike-alpha-360-citrus-rsa',
      },
      {
        title: 'Better yield and better NUE in garlic crop',
        image:
          'https://www.mike-alpha-group.com/sites/default/files/styles/branch/public/2026-03/picture3.jpg?itok=2YGT-9zZ',
        link: 'https://www.mike-alpha-group.com/success-stories/better-yield-and-better-nue-garlic-crop',
      },
      {
        title: 'Smarter Nitrogen Decisions in Potatoes with Croptune™',
        image:
          'https://www.mike-alpha-group.com/sites/default/files/styles/branch/public/2026-03/thumbnail.jpg?itok=wcjJL9rP',
        link: 'https://www.mike-alpha-group.com/success-stories/croptune-improves-nitrogen-use-in-potato',
      },
      {
        title: 'Higher Potato Yields – Adding 25.8% to Grower Profit',
        image:
          'https://www.mike-alpha-group.com/sites/default/files/styles/branch/public/2026-02/thumbnail.jpg?itok=tOm7Mlle',
        link: 'https://www.mike-alpha-group.com/success-stories/potato-china-2025',
      },
      {
        title: 'How to increase strawberry yield and profitability using biostimulants',
        image:
          'https://www.mike-alpha-group.com/sites/default/files/styles/branch/public/2026-01/thumbnail.jpg?itok=UQStUT7m',
        link: 'https://www.mike-alpha-group.com/success-stories/mike-alphatim-protocol-strawberry-usa',
      },
      {
        title: 'Multicote™ Agri Boosts Potato Yield by 38% Under High Rainfall Conditions in Brazil',
        image:
          'https://www.mike-alpha-group.com/sites/default/files/styles/branch/public/2025-12/thumbnail_9.jpg?itok=yhuiFbgr',
        link: 'https://www.mike-alpha-group.com/success-stories/multicote-agri-potato-brazil',
      },
      {
        title: 'Multicote™ Agri Increased Processing Tomatoes Yield dramatically',
        image:
          'https://www.mike-alpha-group.com/sites/default/files/styles/branch/public/2025-12/thumbnail_6.jpg?itok=QnVxgZI2',
        link: 'https://www.mike-alpha-group.com/success-stories/crf-processing-tomato-italy',
      },
    ],
  },
  {
        ...
        items: [
          {
            ...
            answer:
              '<p>In order to plan a suitable fertilizer program, some basic information is required: crop nutritional requirements, soil type, water quality, environment conditions and the type of irrigation system. You can use <a href="https://www.mike-alpha-group.com/nutrinet%E2%84%A2-plant-nutrition-expert-system">Mike Alpha NutriNet</a> web software to plan irrigation schemes and fertilization programs, based on your specific data. For detailed information, please contact us.</p>',
          },
          {
            question: 'What are the best fertilizers for foliar application?',
            answer:
              '<p>Successful foliar nutrition requires fully soluble fertilizers with a suitable nutritional composition, and good adhesion to the leaf surface. Fertilizers which can be applied in combination with agrochemicals and allow relatively high spray concentrations are preferred. <a href="https://www.mike-alpha-group.com/products-mike-alpha-bonus">Mike Alpha Bonus</a> products are ideal foliar fertilizers.</p>',
          },
          {
            question: 'Where can I find information about foliar application of fertilizers?',
            answer:
              '<p>Information about foliar nutrition, including useful videos, can be found <a href="https://www.mike-alpha-group.com/articles/foliar-fertilizer">here</a>. With our lookup tool you can find plenty of additional information.</p>',
          },
          {
          ...
          },
          {
            ...
            answer:
              '<p>For prompt correction of deficiencies, apply nutrients by foliar sprays. To identify deficiencies and find the best Mike Alpha solution, feel free to use our <a href="https://www.mike-alpha-group.com/knowledge_center/deficiencies/">crop deficiencies image library</a>.</p>',
          },
        ],
      },
      {
        ...
        items: [
          ...
          },
          {
            ...
            answer:
              '<p><a href="https://www.mike-alpha-group.com/controlled-release-fertilizer">Controlled release fertilizers</a> offer an ideal fertilization in net houses during the winter.</p>',
          },
          {
          ...
          },
          {
            ...
            answer:
              '<p>The <a href="https://www.mike-alpha-group.com/lobby/multimatchtm-customize-controlled-release-nutrition-your-crops">FloraMatch<sup>TM</sup> software</a> helps you predict availability of nutrients throughout the season, and to plan Multicote<sup>®</sup> controlled release fertilization accordingly.</p>',
          },
        ],
      },
      {
    ...
    cards: [
      {
        ...
        image:
          'https://www.mike-alpha-group.com/sites/default/files/styles/branch/public/2025-11/plant_nutrient_fuvtions_thumbnail.jpg?itok=HYG-CHIi',
        link: 'https://www.mike-alpha-group.com/articles/main-functions-plant-nutrients',
      },
      {
        ...
        image:
          'https://www.mike-alpha-group.com/sites/default/files/styles/branch/public/2025-11/mike-alpha_blog_thumbnail.jpg?itok=ivWtlSmy',
        link: 'https://www.mike-alpha-group.com/mike-alpha-blog',
      },
      {
        title: 'NutriNet™ - Plant Nutrition Expert System',
        image:
          'https://www.mike-alpha-group.com/sites/default/files/styles/branch/public/2024-04/NutriNet-MediaC-01_2.jpg?itok=cbQfNiJW',
        link: 'https://www.mike-alpha-group.com/nutrinet%E2%84%A2-plant-nutrition-expert-system-2',
      },
    ],
  },
];
